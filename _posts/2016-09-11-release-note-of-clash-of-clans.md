...
向您介绍新的防御单位：隐藏的特斯拉电塔！（需要7级大本营）
您现在可以在参观同部落成员是查看他们的部队。
...
完全支持iphone5和ipod5
新功能：魔法药水！！（法术工厂在5级大本营解锁）
向您介绍3种药水：闪电药水，治疗药水和狂暴药水
加入了录像回放系统！你可以了解进攻这是如何入侵你的村庄的。
现在6级大本营就可以建造法师塔。8本可建造的特斯拉电塔增加到3个。
改进了匹配机制，且匹配系统匹配速度更快。
你现在可以看到研究室正在进行的研究了。
更多的视觉效果得到了改进。
支持ios6的gamecenter 成就
iphone和ipod的商店界面改进[以前和ipad一样么
...
现在当玩家加入，推出，被升职，被降职时会有信息出现。
其他改动：
增加了越本惩罚机制。（大本营等级差在2级或2级以上）
现在在维护后有短暂的禁止进攻时间。
增加了额外的和gamecenter的确认步骤防止意外发生。
```
...
Town Hall level 9 added!zingive turret: the X-Bow! This weapon shoots bolts of Elixir with a super fast rate of fire.
...
-下雪了，前所未有的圣诞特效。
-礼盒陷阱将使进攻你的玩家大吃一惊。
-新法术：圣诞突袭，给敌人的村庄带去毁灭性的打击。[。。。。1500伤害。。。。。]
-稀有装饰物，圣诞树
-大的永久性改动：
-匹配机制得到巨大改进。现在搜索到的敌人奖杯和大本营等级将和您的等级更加接近。
-等急了？现在可以加速采集器（5级以上），兵营（4级以上）和法术工厂了！
-排行榜显示每日排名上升下降数据，谁在往上爬，谁在往下掉。
-解锁7级兵营，您可以带领更多军队踏平敌人的村庄。
-注意了9级大本营的首领们。你们可以额外建造一个加农炮了。
-增加了村庄面积。玩家可以建造更大的村庄。
-用皮卡超人神像装饰你的村庄（需要玩家等级75级以上）
-现在防守方的部队可以跳过围墙[。。。。。。。。]就像村名一样。
-平衡改进：
-大本营生命值提高。
-天使生命值提高。
-2.3级的皮卡超人生命值下降。
...
英雄来了！！
向您介绍coc的两位英雄：野蛮人之王&弓箭女王！
英雄是不朽的！不同于其他部队，他们不会在战斗结束后化作圣水，当他们受伤了只需睡一觉就会痊愈。
新资源：暗黑重油，从黑龙的骨骼化石中提炼！！
用暗黑重油来雇佣并升级英雄。
暗黑重油罐在7级大本营解锁。暗黑重油钻井在8级大本营解锁。

吊炸天的新防御设施：
解锁了2.3级的x连弩，升级获得更强的火力！
2个新的城墙等级“痛苦之刺”和“烈焰熔岩”
了解你的部落成员们。
了解你的部落成员那个贡献更高，现在捐收援兵将被记录。

同时开放新成就“患难之交”
新的部落奖杯要求上限提高，最高可以设置为3000杯

平衡调整&bug修复
储存更多的金币和圣水：9级大本营可以建造4个储金罐和圣水瓶。
8级训练营造价降低30%
x连弩可以调节为对空，但射程降低为11格。
x连弩子弹上限降低了25%
您现在可以从外观判断x连弩还剩多少弹药。
圣诞节过去了移除了圣诞突袭药水和礼物炸弹。
```
...
平衡性调整；
我们发现原来皮卡超人的盔甲是导电的。皮卡超人现在成为特斯拉电塔的优先目标并承受额外伤害。
制造药水时间缩短。
部队准备好作战时会有兵营已满提示出现。
9.10级的围墙更难攻破，更好地拖延敌军的进攻。
...
Timestamps in clan chat are now broken.
Laboratory changes refer to Rage Spell as "Haste".
Dragons now deal splash damage.
Wizards now deal splash damage.
[Add your own]
...
城墙久攻不下？ 
炸弹人革新了科技，这些无所畏惧的骷髅直奔城墙并对城墙造成更多伤害。然而招募这些炸弹人需要更多的空间，炸弹人人口提升到2.
...
在实验室工作时也可以查看可升级部队信息。
现在可以查看单人模式进攻的可掠夺资源。
显示可掠夺资源时增加了一个空格（100 000而不是100000）

新功能：战斗中会显示摧毁建筑占总建筑数的百分比。
...
新兵种，新建筑：
戈伦石：召唤强壮的戈伦石人为你的部队吸收伤害，把石人劈成2半也不能阻止它前进的步伐。升级到4级暗黑训练营以解锁戈伦石人。
9级大本营获得额外一个法师塔和一个搜空地雷。
同时5级部落城堡和7级特斯拉电塔也对9本开放。
...
```
 "Town Hall 10 - the Fiery Fortress"
...
10本来了！！！ --炙热要塞
更多加农炮 、箭塔 、巨型炸弹 以及暗黑重油钻井 。
更高级别的野蛮人王 与弓箭王后 。
更高级别的X连弩 和防空火箭 。

全新的防御型建筑：地狱之塔
地狱之塔 喷射的火焰灼热无比，那怕是世上最厚的盔甲也能射穿。
火焰的威力随着时间流动而增强，使它成为攻击具有顽强生命力敌军的利器。
能攻击地面的英雄 、皮卡超人 以及戈伦石人 ，也能攻击空中的飞龙 ，从而拒敌于城门之外。
注意：面对小型敌人的人海战术，地狱之塔 的威力会难以发挥。
...
升级玩家接口
支援中文。
支援更多输入法。在聊天室可以输入各种语言了。
支援符号表情（设定 -> 一般 -> 键盘 -> 键盘 -> 新增键盘 -> 表情符号）
...
游戏平衡改动
减少天使 占用的空间、训练时间与费用。
缩短英雄 的升级时间、恢复时间和某些级别的升级费用。
降低二级、三级和四级的戈伦石人 的训练费用。
降低9级大本营 的升级费用。
降低5级、6级和7级实验室 的升级费用。
降低2级和3级X连弩 的升级费用。
降低7级防空火箭 的升级费用。
...
新的5级法术工厂将解锁冰冻法术。
6级雷电法术能让敌军陷入更强大的雷电风暴。
6级疗伤法术帮你治疗最致命的伤口。

更激烈的战斗
4级的皮卡超人帮你把敌人撕成碎片。
12级的加农炮将向你展示它令人畏惧的火力。
11级的城墙让你的村庄几乎牢不可破。
...
新兵种：女巫！
女巫是黑魔法和死灵法术的大师，女巫召唤骷髅勇士为她作战。升级暗黑训练营至5级来解锁女巫。
无墙可挡的6级炸弹人将为你的部队开辟道路。
在部落聊天室内分享你的回放。每30分钟你就可以分享一则回放。
你现在可以在公频暂时屏蔽其他玩家。
...
重做野猪骑士：野猪骑士现在对防御建筑物优先！同时野猪骑士的重锤将造成更多伤害！
野猪骑士招募时间缩短。
